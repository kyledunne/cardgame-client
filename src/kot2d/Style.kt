...
class Color constructor(var r: Float, var g: Float, var b: Float, var a: Float = 1f): Style {
    ...
    override fun draw(rect: Rect) {
        if (this.a > 0) {
            ...
            GL11.glVertex2f(rect.abx, rect.aby)
            GL11.glVertex2f(rect.abx + rect.w, rect.aby)
            GL11.glVertex2f(rect.abx + rect.w, rect.aby + rect.h)
            GL11.glVertex2f(rect.abx, rect.aby + rect.h)
            GL11.glEnd()
        }
    }
}
